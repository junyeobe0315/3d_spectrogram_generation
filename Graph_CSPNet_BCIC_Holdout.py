...
def main(train, val, test, train_y, val_y, test_y, graph_matrix, 
         adjacency_matrix, sub, total_sub, validation, train_batch_size=256,
         valid_batch_size=32, test_batch_size=32, use_cuda=True, mlp=True, 
         initial_lr=1e-4, alg_name="Graph_CSPNet", weights_folder_path='model_params/',
         patience=15, epochs=50, log_interval=1):
