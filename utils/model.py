...
class Tensor_CSPNet_Basic(nn.Module):
    ...
    def __init__(self, channel_num, mlp, dataset = 'KU'):
        ...
        self.tcn_width        =  9 
        self.Temporal_Block   = nn.Conv2d(1, self.tcn_channels, (self.kernel_size, self.dims[-1]**2), stride=(1, self.dims[-1]**2), padding=0).double()
...
class Graph_CSPNet_Basic(nn.Module):
    ...
    def __init__(self, channel_num, P, mlp, dataset = 'KU'):
        ...
        if self._mlp:
            ...
            self.Classifier = nn.Linear(62208, classes).double()
